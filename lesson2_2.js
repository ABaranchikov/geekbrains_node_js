...
//hh-dd-MM-yyyy
const FINISH_DATE = "02-06-01-2021";
const [day] = process.argv.slice(2);
//const day = "10-06-01-2021";
...
const convertHoursToDate = (value) => {
    ...
    return  "year: " + year + " months: " + month + " day: " + day + " hours: " + hour;
}
...
let current = dateToHours(day) - dateToHours(FINISH_DATE);

//здесь получается счетчик
const run = async () => {
    await delay(1000);
    current--;
    if (current >= 0) {
